...
const Statisticsline = ({ statisticsText, statisticsValue }) => <p>{statisticsText} {statisticsValue}</p>

const Button = ({ buttonCallfunction, textButton }) => <button onClick={buttonCallfunction}>{textButton}</button>

const Statistics = (props) => {
  // console.log('in Statistics', props.arrayClicks)
...
function App() {
  ...
  const goodFeedback = () => {
    // console.log('in goodFeedback ', allClicks)
  ...
  const neutralFeedback = () => {
    // console.log('in neutralFeedback ', allClicks)
  ...
  const badFeedback = () => {
    // console.log('in badFeedback ', allClicks)
    const newBad = bad + 1
    let newAllClicks = allClicks
    setAllClicks(newAllClicks.concat(-1))
    setBad(newBad)       
